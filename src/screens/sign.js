...
import { View, Text, Image, StyleSheet, TouchableOpacity, KeyboardAvoidingView, TextInput, ImageBackground, TouchableWithoutFeedback, Keyboard, } from 'react-native';
                        ...
                        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
                            <View style={{ paddingTop: 50 }}>
                                ...
                                <TextInput placeholder="Password" placeholderTextColor="rgba(155,155,155,0.9)"
                                    ...
                                    style={styles.input} />
                                <TextInput placeholder="Password Confirm" placeholderTextColor="rgba(155,155,155,0.9)"
                                    returnKeyType={"go"}
